...
export function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-void py-12 md:py-16 lg:py-20">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3 md:mt-10 md:gap-4">
          {socials.map((s, i) => (
            <motion.a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-full border border-white/10 bg-white/[0.02] px-5 py-2.5 text-xs font-semibold uppercase tracking-wider text-slate-300 transition hover:border-neon/40 hover:text-neon hover:shadow-[0_0_20px_rgba(34,211,238,0.12)]"
              whileHover={{ y: -4 }}
